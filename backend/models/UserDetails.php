 ...
 * @Last Modified time: 2018-08-12 23:09:49
 */
...
class UserDetails extends \yii\db\ActiveRecord
{
    ...
    public function rules()
    {
        return [
            ...
            [['ud_summary'], 'string'],
            [['ud_mobile', 'ud_location', 'ud_skype_id', 'ud_profile_name', 'ud_role'], 'string', 'max' => 255],
            [['ud_user_id'], 'exist', 'skipOnError' => true, 'targetClass' => User::className(), 'targetAttribute' => ['ud_user_id' => 'id']],
            [['ud_profile_pic'], 'file', 'extensions'=>'jpg, gif, png','skipOnEmpty' => true,'maxSize'=>'1000000'],
        ];
    }
